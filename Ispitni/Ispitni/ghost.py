...
class GhostOnSkates(Problem):
    ...
    def successor(self, state):
        ...
        if (pos_x + 1) <= self.n and (pos_x + 1, pos_y) not in self.walls:
            successors['Desno 1'] = (pos_x + 1, pos_y)
        
        if (pos_x + 2) <= self.n and (pos_x + 2, pos_y) not in self.walls:
            successors['Desno 2'] = (pos_x + 2, pos_y)
            
        if (pos_x + 3) <= self.n and (pos_x + 3, pos_y) not in self.walls:
            successors['Desno 3'] = (pos_x + 3, pos_y)
            
        if (pos_y + 1) <= self.n and (pos_x, pos_y + 1) not in self.walls:
            successors['Gore 1'] = (pos_x, pos_y + 1)
            
        if (pos_y + 2) <= self.n and (pos_x, pos_y + 2) not in self.walls:
            successors['Gore 2'] = (pos_x, pos_y + 2)
            
        if (pos_y + 3) <= self.n and (pos_x, pos_y + 3) not in self.walls:
            successors['Gore 3'] = (pos_x, pos_y + 3)
    ...
    def h(self, node):
        ...
        return euclid_distance(state[0], state[1], self.goal[0], self.goal[1])
